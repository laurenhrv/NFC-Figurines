    ...
    onDeviceReady: function() {
        ...
        nfc.addNdefListener (
            ...
            if (nfc.bytesToString(ndefMessage[0].payload).substring(0, 3) == "Apa") {
                ...
                profother.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(54, 155);
                profstats.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(155, 260);
                bio.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(260, 646);
