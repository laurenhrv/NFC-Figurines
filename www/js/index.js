    ...
    onDeviceReady: function() {
        ...
        nfc.addNdefListener (
            ...
            if (nfc.bytesToString(ndefMessage[0].payload).substring(0, 3) == "Apa") {
                ...
                stat1.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(25, 27);
                stat2.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(27, 29);
                stat3.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(29, 31);
                stat4.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(31, 33);
                stat5.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(33, 35);
                stat6.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(35, 37);
                stat7.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(37, 39);
                stat8.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(39, 41);
                stat9.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(41, 43);
                stat10.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(43, 45);
                stat11.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(45, 47);
                stat12.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(47, 49);
                profother.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(49, 190);
                profstats.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(190, 258);
                bio.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(258, 573);
                spells.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(573, 740);
                feats.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(740, 761);
                number.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(761, 762);
                document.getElementById("mario").src = "img/mario-on.png";
