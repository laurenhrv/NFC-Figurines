    ...
    onDeviceReady: function() {
        ...
        nfc.addNdefListener (
            ...
            if (nfc.bytesToString(ndefMessage[0].payload).substring(0, 3) == "Apa") {
                ...
                feats.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(643, 752);
                number.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(752, 753);
                ...
                stat3.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(52, 53);
                stat4.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(53, 54);
                stat5.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(54, 56);
                ...
                stat8.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(60, 62);
                stat9.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(62, 64);
                stat10.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(64, 66);
                stat11.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(66, 68);
                stat12.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(68, 70);
                profother.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(70, 167);
