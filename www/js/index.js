    ...
    onDeviceReady: function() {
        ...
        nfc.addNdefListener (
            ...
            if (nfc.bytesToString(ndefMessage[0].payload).substring(0, 3) == "Apa") {
                ...
                profother.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(56, 151);
                profstats.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(151, 230);
                bio.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(230, 446);
                spells.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(446, 450);
