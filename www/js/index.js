    ...
    onDeviceReady: function() {
        ...
        nfc.addNdefListener (
            ...
            if (nfc.bytesToString(ndefMessage[0].payload).substring(0, 3) == "Apa") {
                ...
                bio.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(266, 735);
                spells.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(735, 742);
                attacks.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(742, 808);
                feats.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(808, 911);
                equip.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(911, 1083);
                number.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(1083, 1084);
