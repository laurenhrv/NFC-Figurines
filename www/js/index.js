    ...
    onDeviceReady: function() {
        ...
        nfc.addNdefListener (
            ...
            if (nfc.bytesToString(ndefMessage[0].payload).substring(0, 3) == "Apa") {
                ...
                labels.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(24, 45);
                stat1.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(45, 47);
                stat2.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(47, 49);
                stat3.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(49, 50);
                stat4.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(50, 51);
                stat5.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(51, 53);
                stat6.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(53, 55);
                stat7.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(55, 56);
                stat8.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(56, 59);
                stat9.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(59, 61);
                stat10.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(61, 63);
                stat11.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(63, 65);
                stat12.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(65, 67);
                profother.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(57, 167);
                profstats.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(167, 224);
                bio.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(224, 607);
                spells.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(607, 732);
                feats.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(732, 799);
                number.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(799, 800);
