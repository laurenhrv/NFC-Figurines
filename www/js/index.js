    ...
    onDeviceReady: function() {
        ...
        nfc.addNdefListener (
            ...
            if (nfc.bytesToString(ndefMessage[0].payload).substring(0, 3) == "Apa") {
                ...
                profother.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(56, 155);
                profstats.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(155, 240);
                bio.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(240, 646);
                spells.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(646, 650);
                feats.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(650, 753);
