    ...
    onDeviceReady: function() {
        ...
        nfc.addNdefListener (
            ...
            if (nfc.bytesToString(ndefMessage[0].payload).substring(0, 3) == "Apa") {
                ...
                feats.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(643, 753);
                number.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(753, 754);
                ...
                labels.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(24, 47);
                stat1.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(47, 49);
                stat2.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(49, 51);
                stat3.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(51, 52);
                stat4.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(52, 53);
                stat5.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(53, 55);
                stat6.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(55, 57);
                stat7.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(57, 59);
                stat8.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(59, 61);
                ...
                stat12.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(67, 69);
                profother.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(69, 167);
                ...
                feats.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(733, 812);
                number.innerHTML = nfc.bytesToString(ndefMessage[0].payload).substring(812, 813);
